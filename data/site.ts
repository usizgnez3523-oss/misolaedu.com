...
export const services = [
  { title: '留学申请规划', text: '个性化申请方案，精准匹配意大利院校与专业。' },
  { title: '作品集指导', text: '海外名师一对一辅导，完成从创意开发到项目制作。' },
  { title: '院校申请', text: '精准文书、面试辅导、申请递交与录取跟进。' },
  { title: '签证与行前', text: '签证办理、住宿安排、接机服务与行前辅导。' },
  { title: '海外支持', text: '海外生活支持、学业跟进与职业发展陪伴。' },
]
